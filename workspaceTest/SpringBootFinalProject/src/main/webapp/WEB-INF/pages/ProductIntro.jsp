...
<body style="background-image: url(/image/背景4.jpg)">
				...
				<div class="align-items-center mt-5">
					<ul id="menuNav" class="row justify-content-center">
						<li class="row col-2 border justify-content-center"><a
							href="#rice" class="text-white text-center">飯</a></li>
						<li class="row col-2 border justify-content-center"><a
							href="#noodle" class="text-white text-center">麵</a></li>
						<li class="row col-2 border justify-content-center"><a
							href="#beverage" class="text-white text-center">飲料</a></li>
						<li class="row col-2 border justify-content-center"><a
							href="#dessert" class="text-white text-center">點心</a></li>
					</ul>
				</div>
			</div>
	...
	<div class="shoppingcarticon">
		...
		<div class="shoppingcartnum"><p></p></div>
	</div>
</body>
</html>