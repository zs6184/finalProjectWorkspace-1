...
<body id="top" style="background-image: url(/image/背景4.jpg)"/>
	...
	<div class="banner-area bg-img"
		style="background-image: url(/image/img/blog-img/66.png);">
		<div class="container h-100">
			<div class="row h-100 align-items-center">
				<div class="col-12">
	...
	<c:choose>
		<c:when test="${empty catitem}">
			<div class="container" id="container" style="height: 500px;">
				<div class="emptycart">
				<h1>購物車空空</h1>
				<p><a href="/product/findallproduct">商品頁面</a></p>
				</div>
			</div>
		</c:when>
		<c:when test="${not empty catitem}">
			<div class="container" id="container" style="height: 500px;">
					...
					<div class="bottm row">
						<div class="btn">
							...
							<button type="button" class="btn btn-dark"
								onclick="window.open('/order/chackout')">結帳</button>
						</div>
					</div>
				</div>
			</div>
