...
<!--自訂樣式表-->
<link href="/stylesheet/CusBookingCheck.css" rel="stylesheet" />
<!--自訂js-->
<script src="/javascript/CusBookingCheck.js"></script>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-11 bg-white my-3 ms-5 box rounded-3 shadow p-5">
						<p class="font1 border-bottom pb-4">預約訂位紀錄</p>
						<div class="row align-item-center justify-content-center h-75">
							<div class="col-10 rounded-3 shadow p-3 overflow">
								...
								<table class="table table-striped table-hover mt-4 text-center"
									...
									<thead>
										<tr>
											...
											<th scope="col" style="display:none">預定序號</th>
										</tr>
									</thead>
									<tbody class="align-middle">
										<c:forEach var="arrBoo" items="${arrBoo}">
											<tr>
											
												<td>${arrBoo.cusID}</td>
												<td>${arrBoo.cusRealName}</td>
												<td>${arrBoo.bookingsNum}</td>
												<td>${arrBoo.bookingsDate }</td>
												<td>1${arrBoo.bookingsTime}:00</td>
													<td class="ID" style="display:none";>${arrBoo.bookingsID}</td>
												<td>
											
											<button type="button" class="btn btn-danger delete"
												onclick="del(this)">取消預約</button>
										</td>
											</tr>
										</c:forEach>	
									</tbody>
