			...
			<nav id="sidebar" class=" colorGray">
				...
				<ul class="list-unstyled">
					...
					<li><a href="#sublist04" data-bs-toggle="collapse"
						id="dropdown04" class="center sidebarLight01"> <i class="fas fa-cat mx-2"></i>
						...
						<ul id="sublist04" class="list-unstyled collapse show">
							...
							<li><a href="/Users/SelectCustomer.controller" class="itemDetails">領養預約總覽</a></li>
				...
				<div class="row">
					<div class="col-11 bg-white my-3 ms-5 box rounded-3 shadow p-5">
						...
						<div class="row align-item-center justify-content-center">
							<div class="col-10 rounded-3 shadow p-5"">
								<table class="table table-striped table-hover mt-4 text-center" id="infoTable">
									<thead>
										<tr>
