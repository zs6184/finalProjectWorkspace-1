...
<body id="top" style="background-image:url(image/背景4.jpg)" ;>
                        ...
                        <div style="height: 460px;width:332px;" class="row justify-content-center align-items-center">
                            <div class="btn">
                                <button type="button" class="btn btn-dark" id="b2" data-bs-toggle="modal"
                                    data-bs-target="#Reservation">我要訂位</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal-body" style="font-family:BB;font-size: 25px;" ;>
                        <div class="row">
                            <div class="text-center" id="mainbox">
                                ...
                                <BR><BR>
                                <label for="Phone" class=""><span>電話號碼&nbsp&nbsp&nbsp</span></label>
                                <input type="text" id="Phone" name="Phone" />
                                <BR><BR>
                                <label for="number" class=""><span>訂位人數&nbsp&nbsp&nbsp</span></label>
                                <input type="text" id="number" name="number" />
                                <BR><BR>
                                <label for="time" class=""><span>預約時間&nbsp&nbsp&nbsp</span></label>
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div style="display: inline-block; height: 300px;width: 700px;margin: 25px;padding-top:10px">
                <h6 style="float:right">2021年9月15號 22:38</h6>
        ...
        <div class="row justify-content-center">
            <div class="justify-content-center"
                ...
                <h6 style="float:left">2021年9月15號 22:38</h6>
                <h2 style="text-align: center;">新餐點來享受</h2>

                <p style="font-size: 25px;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp人生中最美好的時光就是吃
                    紅羅波佐火腿佐魚肉佐菠菜佐哈密瓜拌飯才是人間美味。: D<br>快來享受美好餐點,現在只要189元就吃的到唷。<br><br>
                    <br&nbsp>&nbsp哈密瓜魚肉紅羅波拌飯&nbsp189元!!!!!!!
                </p>
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div style="display: inline-block; height: 300px;width: 700px;margin: 25px 25px;padding-top:10px">
                <h6 style="float:right">2021年9月15號 22: 38</h6>
    ...
    <div style="text-align: center;font-family: BB;" class="clearfix ">
        </span> <a href="">下一頁</a><span class="current">&nbsp&nbsp1</span>
        <a href="">&nbsp; 2&nbsp; </a>
        <a href="">&nbsp; 3&nbsp; </a>
        <a href="">&nbsp; 4&nbsp; </a>
        <a href="">&nbsp; 5&nbsp; </a>
    ...
    <div class="fix"><a href="#top">TOP</a></div>
