...
public class BookingsBean implements Serializable{
	...
	public Integer getBookingsNum() {
		return bookingsNum;
	}
	public void setBookingsNum(Integer bookingsNum) {
	...
	public BookingsBean(Integer bookingsID, Integer cusID, String cusRealName, String phone, Integer bookingsNum,
