...
$(function() {
	...
	$("#username").blur(function() {
		...
		$.ajax({
			method: "post",
			url: "http://localhost:8080/NoXmlSpringMvcProject/CreateCusAccountCheckUsername.controller",
			data: dataForm,
	...
	$("#phoneNumber").blur(function() {
		...
		$.ajax({
			method: "post",
			url: "http://localhost:8080/NoXmlSpringMvcProject/CreateCusAccountCheckPhone.controller",
			data: dataForm,
			success: function(data) {
				console.log(data);
	...
	$("#email").blur(function() {
		...
		$.ajax({
			method: "post",
			url: "http://localhost:8080/NoXmlSpringMvcProject/CreateCusAccountCheckEmail.controller",
			data: dataForm,
			success: function(data) {
	...
	$("#createCusForm").submit(function() {
		...
		$.ajax({
			method: "post",
			url: "http://localhost:8080/NoXmlSpringMvcProject/CreateCusAccount.controller",
			data: dataForm,
			success: function(data) {
				if (data == "pass") {
					console.log(data);
