package iii.boothomework.config;
...
public class WebAppConfig implements WebMvcConfigurer {
	...
	public void addViewControllers(ViewControllerRegistry registry) {
		...
		registry.addViewController("/loginIndex.Controller").setViewName("loginIndex");
		registry.addViewController("/logoutIndex.Controller").setViewName("logout");
	}
